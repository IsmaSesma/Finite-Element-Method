...
casestoread1 = {'Placa_Ref','Placa_180_acel_bot','Placa_250_acel_bot'};
...
%     semilogy(vf,test.(casestoread2{2}).amp)
    ...
    box;grid;
    legend('Tunned to 180 Hz, test', 'Tunned to 250 Hz, test', 'Homogeneous, FEM','Holed, FEM','Location','SouthEast')
    xlabel('Frequency (Hz)')
